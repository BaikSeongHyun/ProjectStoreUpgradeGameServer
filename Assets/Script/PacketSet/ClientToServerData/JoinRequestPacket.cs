...
public class JoinRequestPakcet : Packet<JoinRequestData, JoinRequestSerializer>
{
	// constructor - packet data
	public JoinRequestPakcet( JoinRequestData data )
	{
		// allocate serialier
	...
	public JoinRequestPakcet( byte[] data )
	{
		// allocate serializer
		serializer = new JoinRequestSerializer();
